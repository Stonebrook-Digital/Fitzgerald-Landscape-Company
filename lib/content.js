...
export const serviceArea = {
  title: "Service Area",
  copy:
    "Proudly serving Woodbury, New Jersey and the surrounding areas, including Wenonah, West Deptford, National Park, Pitman, Mantua, and more.",
...
export const trustedBrands = {
  ...
  brands: [
    { id: "stihl", name: "STIHL", logo: "/STIHL-logo-transparent.png" },
    { id: "toro", name: "Toro", logo: "/toro-shield.png" },
    { id: "echo", name: "Echo", logo: "/echo.png" },
    { id: "redmax", name: "RedMax", logo: "/redmax-logo.png" },
    { id: "hunter", name: "Hunter", logo: "/logo_guidelines_do_00-black.jpg", logoScale: 1.15 },
    { id: "lesco", name: "LESCO", logo: "/lesco.png", logoScale: 1.55 },
    {
      id: "western",
    ...
    { id: "belgard", name: "Belgard", logo: "/belgard.png" },
    { id: "saltdogg", name: "SaltDogg", logo: "/saltdogg.png", logoScale: 1.6 },
  ],
};
...
export const googleReviews = {
  ...
  count: 48,
  externalHref:
    "https://www.google.com/search?q=Fitzgerald+Landscape+Co+Woodbury+NJ+reviews",
